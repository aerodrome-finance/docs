...
<iframe
  src="https://www.desmos.com/calculator/yiwx8ev1oh?embed"
  width="100%"
  height="700"
></iframe>
...
- Stable token pools can use a price range boundary of 0.5% (tick space 50) for tokens like USDC, DAI, LUSD.

- Volatile token pools can use a price range boundary of 1% or 2% (tick space 100 or 200) for tokens like cbBTC and WETH.
...
- For emerging tokens like AERO, a price range boundary of 20% (tick space 2000)
...
within the pool current price range (active tick).
